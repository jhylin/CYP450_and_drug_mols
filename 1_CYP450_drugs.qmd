...
*May need to look further into MCS functionalities/presets in RDKit...*
...
# MCS not very obvious here...
```

```{python}
## To try and align these antivirals first (if possible?)
