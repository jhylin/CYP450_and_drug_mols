...
Keeping the one with max phase marked as 4.0 (the other two had "NaN").
...
May do this in separate smaller sections e.g. antifungals, macrolides, antivirals etc.
...
# Code example from https://rdkit.org/docs/GettingStartedInPython.html#findmcs with bits of my temporary draft code 
