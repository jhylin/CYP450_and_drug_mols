...
[Code example](https://gist.github.com/iwatobipen/6d8708d8c77c615cfffbb89409be730d) from iwatobipen below showed how to highlight molecular differences (opposite to highlighting only the MCS part). Alternative URL link and more examples can be accessed via [RDKit Cookbook](https://rdkit.org/docs/Cookbook.html#highlight-molecule-differences).
...
Thanks to every contributor, developer or authors of every software package used in this post, and also the online communities that are behind them. 