...
###### **Looking into duplicated structures**
...
There is only one stereocentre for "itraconzole", which will match the CHEMBL224725 entry for "itraconzole" in PubChem. Well, without looking into other cross-referencing sources, and if only sticking with PubChem, then I'd opt for this CHEMBL224725 version of "itraconzole".

**Update dfs on quinidine (df_2d6_s_inh_p) & itraconzaole(df_3a4_s_inh_p)**
...
* There are 3 antifungals, 2 macrolides, about 5 antivirals and 4 kinase inhibitors (ceritinib, tucatinib, idelalisib, ribociclib) in this category
