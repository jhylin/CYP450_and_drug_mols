...
1. *Structural alerts* (known to cause adverse drug effects or PAINs)
...
3. *Cytochrome P450 enzymes* (CYP450, CYP isoenzymes, CYP or CYPs)

Other useful categories involved skin sensitisations, drug-induced liver injuries and more.

CYP450 enzymes also played a key role in the toxicology part of ADMET process of therapeutic drugs, I thought to look into the relationship between CYP450 and small drug molecules initially to see if there was anything interesting for further explorations. 

There were 5 main ones that are usually being investigated which are CYP3A4, 2D6, 1A2, 2C9 and 2C19, but there are in fact more than these 5 CYPs, other CYPS are CYP1A1, 2A6, 2B6, 2C8, 2E1, 2J2, 3A5 (note: amlodipine), 3A7 and 4F2 (cite Guengerich paper).
