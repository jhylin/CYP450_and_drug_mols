...
# Testing single molecules - quinidine (index row 3)

quinidine_3 = Chem.MolFromSmiles('C=C[C@H]1CN2CCC1C[C@@H]2[C@@H](O)c1ccnc2ccc(OC)cc12')
quinidine_3

# No need for the following line to show image!
# Draw.MolsToGridImage((test), subImgSize=(250,250))
```
...
Quinidine has 4 defined atom stereocentre count as per PubChem compound summary (as one of possible references for cross-checking) - https://pubchem.ncbi.nlm.nih.gov/compound/441074#section=Computed-Properties&fullscreen=true
