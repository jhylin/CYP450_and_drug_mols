...
df_3a4_strong_inh.to_csv("strong_3a4_inh.csv", sep='\t', index=False)
df_3a4_strong_inh
```
...
df_3a4_mod_inh.to_csv("mod_3a4_inh.csv", sep='\t', index=False)
df_3a4_mod_inh
```
...
df_2d6_strong_inh.to_csv("strong_2d6_inh.csv", sep='\t', index=False)
df_2d6_strong_inh
```
...
df_2d6_mod_inh.to_csv("mod_2d6_inh.csv", sep='\t', index=False)
df_2d6_mod_inh
```

* Will look at the two largest group of CYP inhibitors first
